...
\vspace{2cm}
\centerline{\huge\bfseries Aplikace pro vizualizaci a analýzu dat z in-situ měření RHEED při epitaxi monoatomárních vrstev pomocí technologie MBE\par}
\vspace{0.5cm}
